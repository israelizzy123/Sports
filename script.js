...
function showTrophy(el){
	document.getElementById('rams').src = "images/lombardi_trophy1.png";
	document.getElementById('pats').src ="images/lombardi_trophy1.png";
	document.getElementById('center').src ="images/lombardi_trophy1.png";
